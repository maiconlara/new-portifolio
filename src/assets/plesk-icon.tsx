...
export const PleskIcon = ({ size }: IconProps) => {
  return (
    <svg
      version="1.1"
      id="Layer_1"
    ...
    >
      ...
      <rect className="st0" width="500" height="500" />
      <g>
        <path
        fill="#fff"
          d="M53.3,336.9H40.6v-133c10.1-3.2,20.7-4.9,31.4-5c6.9-0.1,13.8,1.1,20.3,3.5c5.8,2.1,11.2,5.4,15.7,9.7
        ...
        <path
        fill="#fff"
        d="M147.1,291.4V163.1h12.8v128.2h-12.8V291.4z" />
        <path

        fill="#fff"
          d="M264.8,278c-4.1,4.5-9.2,8.1-14.8,10.5s-12.4,3.6-20.3,3.6c-6.6,0.1-13.2-1.1-19.3-3.8c-5.3-2.3-10-5.8-13.7-10.2
        ...
        fill="#fff"
          d="M351.3,221.4c-2.8-3.7-6.3-6.7-10.4-8.9c-4.1-2-8.7-3-13.2-2.8c-6.5,0-11.1,1.2-13.7,3.5c-2.6,2.2-4,5.4-3.9,8.8
        ...
        <path
        fill="#fff"
          d="M385.3,291.4V163.3h12.8v128.1L385.3,291.4L385.3,291.4z M398.2,244.1l44-44.4h17.2l-45.1,44l44.9,47.6h-17.8L398.2,244.1z
		"
        />
        <path 
        fill="#fff"
        className="st1" d="M191.7,336.9h-77.2v-12.1h77.2V336.9z" />
      </g>
    </svg>
  );
};
